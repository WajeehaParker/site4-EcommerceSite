		...
		<div class="wrap elementor-admin-page-license">
			...
			<form class="elementor-license-box" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<?php if ( empty( $license_key ) ) : ?>
					...
					<input placeholder="enter anything here" id="elementor-pro-license-key" class="regular-text code" name="elementor_pro_license_key" type="text" value="" placeholder="<?php esc_attr_e( 'Please enter your license key here', 'elementor-pro' ); ?>"/>
				...
				<?php else :
					...
					<input placeholder="enter anything here" id="elementor-pro-license-key" class="regular-text code" type="text" value="<?php echo esc_attr( self::get_hidden_license_key() ); ?>" disabled/>
